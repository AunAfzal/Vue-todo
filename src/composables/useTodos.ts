...
// The state will be shared across all components that use this composable
...
const loadTodos = () => {
  ...
  if (savedTodos) {
    // When parsing, we need to convert date strings back to Date objects
...
// The composable function that exposes the state and methods
export function useTodos() {
  ...
  const updateTodo = (id: number, updatedData: Partial<Omit<Todo, 'id'>>) => {
